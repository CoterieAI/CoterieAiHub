...
class hasTeamDetailPermissions(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if request.method in ['DELETE']:
            ...
            return is_owner or has_owner_priviledge # -> no admin priviledge here: request.user.is_superuser
...
class IsOwnerOrContributor(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if request.method in ['PUT', 'PATCH']:
            ...
            return is_owner or is_not_viewer # -> no admin priviledge here: request.user.is_superuser
